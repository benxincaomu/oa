...
@Entity
@Table(name = "flow_form_assignee_sample", indexes = {
        @Index(name = "flow_form_assignee_sample_workbench_id_index", columnList = "workbenchId,actived") ,
        @Index(name = "flow_form_assignee_sample_flow_form_id_index", columnList = "flowFormId")
    })
@Comment("流程表单审批人表")
